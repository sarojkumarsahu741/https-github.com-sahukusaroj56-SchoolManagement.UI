...
export class StudentFormComponent implements OnChanges {
  ...
  model: Student = {
    no: '',
    name: '',
    profilePic: 'https://storage.googleapis.com/a1aa/image/80d6e9cf-3584-4a80-c39c-5e2d17b41a39.jpg', // Default
    rollNum: '',
    className: '',
  ...
  classes = ['12 - A', '11 - B', '10 - C']; // Example classes
  ...
  resetForm() {
    this.model = {
      no: '',
      name: '',
      profilePic: 'https://storage.googleapis.com/a1aa/image/80d6e9cf-3584-4a80-c39c-5e2d17b41a39.jpg',
      rollNum: '',
      className: '',
