...
import { SidebarComponent } from '../../src/shared/layout/sidebar/sidebar.component'; // Your SidebarComponent
import { StudentsComponent } from './../components/masters/students/students.component'; // Your StudentsComponent (assuming it's a direct child or needed in root for some reason)
...
@Component({
  ...
  imports: [
    RouterOutlet,
    CommonModule,
    ConfirmDialogModule, // Client's module
    SidebarComponent,    // Your module
    StudentsComponent    // Your module
  ],
